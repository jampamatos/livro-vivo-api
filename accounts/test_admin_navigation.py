...
class AdminNavigationTests(TestCase):
    ...
    def test_admin_navigation_is_grouped_by_operational_domain(self):
        ...
        self.assertIn('Identidades externas', model_names)
        self.assertIn('Documentos legais', model_names)
        self.assertIn('Aceites legais', model_names)
    ...
    def test_admin_index_renders_new_groups(self):
        ...
        self.assertContains(response, 'Identidades externas')
        self.assertContains(response, 'Documentos legais')
        self.assertContains(response, 'Aceites legais')
